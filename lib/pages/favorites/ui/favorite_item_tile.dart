...
class FavoriteItemTile extends StatelessWidget {
  final Watch watch;
  const FavoriteItemTile({super.key, required this.watch});
          ...
          child: Card(
            ...
            children: [
              ...
              Padding(
                ...
                child: IconButton(icon: Icon(Ionicons.trash_outline, size: 40, color: Theme.of(context).primaryColorDark), onPressed: () => favorites.remove(watch)),
              )
            ],
          )),
        ));
